...
//  Forgery
//
//  Created by Ben Urban on 5/30/11.
//  Copyright Ben Urban <benurban@users.sourceforge.net> 2011. All rights reserved.
//
...
int main(int argc, char *argv[])
{
    ...
    NSArray *pythonPathArray = [NSArray arrayWithObjects:
                                resourcePath,
